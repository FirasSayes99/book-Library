    ...
    <li class='nav-item'>
        ...
        <div id='collapsePages' class='collapse' aria-labelledby='headingPages' data-parent='#accordionSidebar'>
            <div class='bg-white py-2 collapse-inner rounded'>
                ...
                <a class='collapse-item' href='viewtest.php'>تعديل كتاب</a>
...
<div id='content-wrapper' class='d-flex flex-column'>
    ...
    <!-- Main Content -->
            <div id='content'>
                ...
                $user_query=mysqli_query($conn, "select * from login_user");
                while($user_rows=mysqli_fetch_array($user_query)){

                
                ?>
                 
                    <tr>
                        <td><?php echo $user_rows['id'] ; ?></td>
                        <td><?php echo $user_rows['name'] ; ?></td>
                        <td><?php echo $user_rows['userName'] ; ?></td>
                        <td><?php echo $user_rows['password'] ; ?></td>
                        
                        
                        <td><a href="xuserUpdate.php<?php echo '?id='.$user_rows['id']; ?>">تعديل</a></td>
                        <td><a href="xuserDelet.php<?php echo '?id='.$user_rows['id']; ?>">حذف</a></td>
                    </tr>
                    <?php }?>
                </table>
